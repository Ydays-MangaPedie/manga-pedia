      ...
      {router.asPath.startsWith('/manga/naruto') ? (
        <div className={styles.page}>
          <div className={styles.resume}>
            ...
            <h1>Résumé</h1>
            <p>
              Naruto est un jeune ninja qui rêve de devenir Hokage, le chef de
              son village. Mais pour y parvenir, il devra affronter de nombreux
              ennemis et surmonter bien des épreuves.
            </p>
          </div>
